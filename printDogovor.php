...
<div class="mt-4">
        <p style="text-align: justify;"> ' . $name_zakazchik . ', именуемое в дальнейшем «<strong>Заказчик</strong>» в лице ' . $name_zakazchik . ', действующего на основании Устава с одной стороны, и <strong>ООО «ИЗИСКОМ»</strong> в лице директора Лукьяновича А.В., действующего на основании Устава, именуемое в дальнейшем <strong>«Подрядчик»</strong>, с другой стороны, вместе именуемые - Стороны, заключили настоящий Договор о нижеследующем:</p>
    </div> 
    <div class="mt-8">
        <h2 class="text-lg font-bold">1. ПРЕДМЕТ ДОГОВОРА</h2>
        <p class="mt-2">1.1. <strong>Заказчик</strong> поручает, а <strong>Подрядчик</strong> обязуется выполнить ' . $name_work . ' с последующей выдачей соответствующего заключения.</p>
    ...
    <div class="mt-8">
        ...
        <p class="mt-2">2.2. В случае не своевременного выполнения <strong>Заказчиком</strong> обязательства, изложенного в п. 3.1.1 настоящего Договора, <strong>Подрядчик</strong> имеет право сместить срок выполнения на соответствующее число дней.</p>
    </div>
     <div class="mt-8">
        <h2 class="text-lg font-bold">3. ПРАВА И ОБЯЗАННОСТИ СТОРОН</h2>
        <p class="mt-2">3.1. <strong>Заказчик</strong> обязуется:</p>
        <p class="ml-4 mt-2">3.1.1. Содействовать <strong>Подрядчику</strong> в обеспечении свободного, непрерывного и безопасного доступа к строительным конструкциям объекта на весь период действия договора.</p>
        <p class="ml-4 mt-2">3.1.2. Предоставить имеющуюся техническую документацию по объекту <strong>Подрядчику</strong> для изучения.</p>
        <p class="ml-4 mt-2">3.1.3. В случае необходимости своевременно информировать <strong>Подрядчика</strong> о предполагаемых изменениях в техническом состоянии объекта.</p>
        <p class="ml-4 mt-2">3.1.4. Обеспечить своевременную приемку работ по настоящему договору.</p>
        <p class="ml-4 mt-2">3.1.5. При необходимости произвести своими силами и за свой счет вскрытия в строительных конструкциях в местах отбора образцов, определённых <strong>Подрядчиком</strong>.</p>
        <p class="mt-2">3.2. <strong>Подрядчик</strong> обязуется:</p>
        ...
        <p class="ml-4 mt-2">3.2.3. <strong>Подрядчик</strong> имеет право привлекать для проведения или обеспечения некоторых видов работ по настоящему договору сторонние (субподрядные) организации.</p> 
    </div>';

echo '     <div class="mt-8">
        <h2 class="text-lg font-bold">4. СТОИМОСТЬ РАБОТ И ПОРЯДОК ОПЛАТЫ</h2>
        <p class="ml-4 mt-2">4.1. Стоимость работ определена на момент составления договора, согласно утвержденной сторонами смете (Приложение №1) и составляет:<strong> ' . $rubli.','.$kopeiki . ' (' . $result_rubli . ' ' . $stringP . ' ' . $result_kopeiki . ' ' . $stringK. ')</strong>, без НДС (в связи с применением УСН).
         - внесения <strong>Заказчиком</strong> изменений в первоначальное задание, влекущее за собой изменение объемов обследовательских работ;
        ...
        <p class="ml-4 mt-2">4.3. Расчет за выполненные работы производится путем банковского перевода денежных средств на расчетный счет <strong>Подрядчика</strong> в течение 5 банковских дней со дня подписания акта сдачи-приёмки выполненных работ.</p>
        <p class="ml-4 mt-2">4.4. В случае приостановления или прекращения работ по инициативе <strong>Заказчика</strong> окончательный расчет производится за фактически выполненный объем работ с учетом фактических затрат <strong>Подрядчика</strong> в течение пяти банковских дней после подписания акта сдачи-приемки выполненных работ.</p>
        ...
        <p class="ml-4 mt-2">4.6. Источник финансирования – '.$istochnik.'.</p> 
    </div>';
...
echo '     <div class="mt-8" style="page-break-after: always;">
        <h2 class="text-lg font-bold">6. ОТВЕТСТВЕННОСТЬ СТОРОН</h2>
        <p class="ml-4 mt-2">6.1. За невыполнение или ненадлежащее выполнение обязательств по настоящему договору <strong>Заказчик</strong> и <strong>Подрядчик</strong> несут имущественную ответственность в соответствии с действующим законодательством Республики Беларусь.
</p>
...
echo '     <div class="mt-8">
        ...
        <p class="ml-4 mt-2">9.1. <strong>Заказчик: ' . $name_zakazchik . '   </strong>
'.$rekvizit.'
</p>
  <p class="ml-4 mt-2">9.2. <strong>Подрядчик: ООО «ИЗИСКОМ»</strong>
