...
<div class="mt-4">
    ...
    <div class="mt-8">
        ...
        <p class="mt-2 no-margin">1.1. <strong>Заказчик</strong> поручает, а <strong>Подрядчик</strong> обязуется выполнить ' . $name_work . ' с последующей выдачей соответствующего заключения.</p>
...
echo '     <div class="mt-8">
        ...
        <p class="ml-4 mt-2 no-margin">4.1. Стоимость работ определена на момент составления договора, согласно утвержденной сторонами смете (Приложение №1) и составляет:<strong> ' . $rubli.','.$kopeiki . ' (' . $result_rubli . ' ' . $stringP . ' ' . $result_kopeiki . ' ' . $stringK. ')</strong>, без НДС (в связи с применением УСН).</p>
