...
if (!$connectionDB) {
    ...
    $sql = "INSERT INTO faults (date_fault, date_call_service, reason_fault, date_procedure_purchase, cost_repair, time_repair, downtime,id_oborudovanie)
            VALUES ('$date_fault', '$date_call_service', '$reason_fault', '$date_procedure_purchase', '$cost_repair', '$time_repair', '$downtime','$id_oborudovanie')";
