...
<section class="col-lg-12 connectedSortable ui-sortable" style="margin-top: 90px">
    ...
    <div class="nameforblock1" onclick="toggleDisplay('.nameforblock1', '.dndb');">Характеристика
        объекта <?php echo '<span class="countRub">123</span>' ?></div>
    <div class="dndb">
        <div class="position1">
            <div class="pos1">
                <div class="viborvis">
            ...
            <div class="pos2">
                ...
                <div class="viborvis">
                    ...
                    <label for="calendarDays" class="visotarad"> 1) Здание высотой до 6м, бескрановое, однообъемное,
                        двухпролетное</label>
                    <br>
                    <input id="vis614" class="butrad" type="radio" name="daysType" value="vis614">
                    <label for="workingDays" class="visotarad">2) Здание высотой от 6м до 14м высоты, с кранами
                        грузоподъемностью до 50т включительно, с двумя объемами, 3-5 пролета
                    ...
                    <label for="workingDays" class="visotarad">2) Здание высотой более 14м, со сложной конструктивной
                        схемой, с двухъярусным расположением кранов, более 3
        ...
        <div class="position1">
            <div class="pos1">
                <div class="viborvis">
                    <label>
                        <input type="checkbox" id="toggleSelect"> Выполнение работ с применением альпинисткого
                        снаряжения (K = 1.5)
                    </label>
                    <label>
                        <input type="checkbox" id="toggleSelect"> Шумовые воздействия, превышающие нормативные величины
                        (K = 1.25)
                    </label>
                    <label>
                        <input type="checkbox" id="toggleSelect"> Выполнение работ в условиях отрицательных температур в
                        период с 1 ноября - 1 мая (K = 1.2)
                    </label>
                    <label>
                        <input type="checkbox" id="toggleSelect"> Необходимость очистки поверхности конструкций от
                        грязи, пыли, ржавчины. Расчет выполнять по калькуляции трудозатрат
                    </label>
            ...
            <div class="pos2">
                ...
                <div class="viborvis">
                    <label>
                        <input type="checkbox" id="toggleSelect"> Необходимость использования переносных источников
                        освещения (K = 1.2)
                    </label>
                    <label>
                    ...
                    <label>
                        <input type="checkbox" id="toggleSelect"> Обследование в условиях производственного процесса (K
                        = 1.2)
                    </label>
                    <label>
                        <input type="checkbox" id="toggleSelect"> Выполнение работ с мостового крана или подмостей (K =
                        1.15)
                    </label>
                </div>
            </div>
            <div class="pos3">
                <div class="viborvis">
                    <label>
                        <input type="checkbox" id="toggleSelect"> Здание оборудовано кранами режимных групп 7К, 8К, (K =
                        1.2)
                    </label>
                    <label>
                        <input type="checkbox" id="toggleSelect"> Конструкции, усиленные по ранее разработанным проектам
                        (K = 1.2)
                    </label>
                    <label>
                        <input type="checkbox" id="toggleSelect"> Использование ранее выполненных обследований не более
                        3 лет назад (K = 0.7)
                    </label>
                    <label>
                        <input type="checkbox" id="toggleSelect"> Срочное выполнение обмерно-обследовательских работ (K
                        <= 1.35)
                    </label>
                </div>
            </div>
    ...
    <div class="nameforblock3" onclick="toggleDisplay('.nameforblock3', '.dndb3');">Сбор исходных
        данных <?php echo '<input class = "onCollap" type="checkbox" id="sborDann" name="sborDann" value="sborDann"> <span class="countRub">123</span>' ?></div>
    <div class="dndb3">
        ...
        <div class="mainfreename">
            ...
            <div class="freeName2" style="    margin-left: 19%;">
                <label>
                    <input type="checkbox" id="choosCunstruct" onchange="toggleCheckboxes()"> Конструкции (если
        ...
        <div class="position1">
            ...
            <div class="pos1">
                <div class="viborvis">
                    ...
                    <br>
                    <input id="workingDays" class="butrad" type="radio" name="daysType" value="working">
                    <label for="workingDays" class="pasportzd">2) Паспорт на здание или сооружение. Проектная
            ...
            <div class="pos2">
                <div class="viborvischeckbox1">
                    <div class="mainlolspace">
                        <div class="lolspace">
                            <input type="checkbox" id="toggleZd1" disabled onchange="toggleCheckboxesDop()"> Конструкция
                            фундаментов
                        </div>
                        <div id="inputContainer" class="input-container">
                            <input class="inpval" id="conval1" disabled type="number" name="inputValue" step="1"
                                   min="0"> %
                        </div>
                    </div>
                    ...
                    <div class="mainlolspace">
                        ...
                        <div id="inputContainer" class="input-container">
                            <input class="inpval" id="conval2" disabled type="number" name="inputValue" step="1"
                                   min="0"> %
                        </div>
                    </div>
                    ...
                    <div class="mainlolspace">
                        ...
                        <div id="inputContainer" class="input-container">
                            <input class="inpval" id="conval3" disabled type="number" name="inputValue" step="1"
                                   min="0"> %
                        </div>
                    </div>
                    ...
                    <div class="mainlolspace">
                        <div class="lolspace">
                            <input type="checkbox" id="toggleZd4" disabled onchange="toggleCheckboxesDop()"> Колонны,
                            столбы, стойки
                        </div>
                        <div id="inputContainer" class="input-container">
                            <input class="inpval" id="conval4" disabled type="number" name="inputValue" step="1"
                                   min="0"> %
                        </div>
                    </div>
                    <div class="mainlolspace">
                        <div class="lolspace">
                            <input type="checkbox" id="toggleZd5" disabled onchange="toggleCheckboxesDop()"> Несущие
                            конструкции копров,пролетных строейний галерей
                        </div>
                        <div id="inputContainer" class="input-container">
                            <input class="inpval" id="conval5" disabled type="number" name="inputValue" step="1"
                                   min="0"> %
                        </div>
                    </div>
            ...
            <div class="pos3">
                ...
                <div class="viborvischeckbox2">
                    <div class="mainlolspace">
                        <div class="lolspace">
                            <input type="checkbox" id="toggleZd6" disabled onchange="toggleCheckboxesDop()"> Подкрановые
                            и тормозные конструкции
                        </div>
                        <div id="inputContainer" class="input-container">
                            <input class="inpval" id="conval6" disabled type="number" name="inputValue" step="1"
                                   min="0"> %
                        </div>
                    </div>
                    ...
                    <div class="mainlolspace">
                        ...
                        <div id="inputContainer" class="input-container">
                            <input class="inpval" id="conval7" disabled type="number" name="inputValue" step="1"
                                   min="0"> %
                        </div>
                    </div>
